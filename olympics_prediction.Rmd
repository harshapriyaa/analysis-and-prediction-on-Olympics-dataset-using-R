...
By using all these methods we were able to create our model. By looking at the adjusted R squared of 86.62% and the VIF values we were able to determine that out model was a good model. 
